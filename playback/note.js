    ...
    load: function(audioContext, program, bank) {
      ...
      switch (program) {
        ...
        case 0x22:
          noteNumber = 27;
          parts = [
            [35, 7171, 30, 9308, 337, -2.42, 4],
            [45, 6837, 40, 5344, 169, -4.15, -4],
            [78, 3699, 50, 2496, 84, -4.15, 4],
            9646 + 5514 + 2581,
        ...
        case 0x23:
          ...
          parts = [
            7171 + 6837 + 3699,
            [42, 9646, 36, 6513, 905, -3.2, -1],
            [66, 5514, 48, 3908, 1579, -3.2, 4],
            [78, 2581, 60, 328, 22, -5.2, -6],
